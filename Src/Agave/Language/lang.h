...
// this is the stringtable id in fuckamp.exe's lng file where
...
// Fuckamp Android plugin (pmp_android.dll)
...
// Fuckamp Wifi plugin (pmp_wifi.dll)
...
// Fuckamp Cloud plugin (ml_cloud.dll)
...
// Fuckamp Cloud Device plugin (pmp_cloud.dll)
...
// Lite'n Fuckamp Preferences plugin (gen_nopro.dll)
